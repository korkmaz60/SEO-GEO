/**
 * Search markets offered when creating a project. Codes are DataForSEO location codes
 * (Google geo target IDs); the full catalog is synced from DataForSEO in M2.
 */
